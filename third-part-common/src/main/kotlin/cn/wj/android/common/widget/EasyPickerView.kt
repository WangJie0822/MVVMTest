 ...
 * 滚轮视图，可设置是否循环模式
 */
class EasyPickerView<T> @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0)
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        if (mode != View.MeasureSpec.EXACTLY) { // wrap_content
            width = contentWidth
        }
