...
class DashView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null) : View(context, attrs) {
    ...
    companion object {
        ...
        const val DEFAULT_DASH_WIDTH = 100
        const val DEFAULT_LINE_WIDTH = 100
        const val DEFAULT_LINE_HEIGHT = 10
        ...
        /** 默认为水平方向 */
        const val DEFAULT_DASH_ORIENTATION = HORIZONTAL
    }
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        widthSize = View.MeasureSpec.getSize(widthMeasureSpec) - paddingLeft - paddingRight
        heightSize = View.MeasureSpec.getSize(heightMeasureSpec - paddingTop - paddingBottom)
