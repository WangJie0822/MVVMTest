...
import static cn.wj.android.common.widget.topsnackbar.AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR;
...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
     ...
     *
     * @param duration either be one of the predefined lengths: {@link #LENGTH_SHORT}, {@link #LENGTH_LONG}, or a custom
    ...
    public abstract static class BaseCallback<B> {
         ...
         * @param event              The event which caused the dismissal. One of either: {@link #DISMISS_EVENT_SWIPE},
         *                           {@link #DISMISS_EVENT_ACTION}, {@link #DISMISS_EVENT_TIMEOUT}, {@link
         *                           #DISMISS_EVENT_MANUAL} or {@link #DISMISS_EVENT_CONSECUTIVE}.
         *
